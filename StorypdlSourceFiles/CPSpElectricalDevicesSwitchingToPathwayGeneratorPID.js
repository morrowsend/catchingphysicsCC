// {CPSpElectricalDevicesSwitchingToPathwayGeneratorPID}{800}{600}
...
function draw() {
	...
	var topslice = 1-twoWayDivvy.getValue(0);
	 ...
	 describePowerTwo("mechanical","particles","electrical",topslice,bottomslice);

	titleBold('A generator switches to the electrical pathway');
}
