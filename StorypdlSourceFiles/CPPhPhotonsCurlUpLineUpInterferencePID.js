...
detectorlocationadjusted=createVector(detectorinitialLoc[0],detectorinitialLoc[1]);
 ...
 for (let i = 0; i<numberWaypoints; i++){
    ...
    slitsbutton = new checkButton(686, 60,"show slits",false);
...
// 	pop();
	...
	push();
		translate(detectorlocation.x, detectorlocation.y);
		phasormultipleresultant(4, .08, [[triptimes[0],contribcolours[0]],[triptimes[1],contribcolours[1]]]);
	pop();
	



titleBold("Arrange to describe interference: contributions curling up or lining up");
