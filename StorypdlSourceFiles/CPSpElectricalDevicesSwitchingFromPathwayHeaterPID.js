// {CPSpElectricalDevicesSwitchingFromPathwayHeaterPID}{800}{600}
...
function draw() {
	...
	var topslice = 1-twoWayDivvy.getValue(0);
	 ...
	 drawDescribePowerTwo("electrical","particles","particles",topslice,bottomslice);

	placeTitleBold('A heater switches from the electrical pathway');
}
