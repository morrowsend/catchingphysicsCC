...
//            paused
		...
		push();
			...
			if (mimicbutton.buttonisChecked){
				for (i = 1; i < numbermimics; i++) {
					...
					showDisplacement(theamplitude*sin(thefrequency*(runtime-i*thedelay)), 0, CIDEAGREEN);
				}
			}
		pop();
    }
  ...
  placeTitleBold("Up-and-down motions copied: transverse waves");
}
