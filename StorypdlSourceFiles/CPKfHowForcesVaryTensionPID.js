...
function setup(){
    ...
    exploreThisGraph.create(270,150,200,1,"distortion / m","tension / N");
...
function draw() {
    ...
    var x = -exploreThisGraph.getValues().xSet*1.7;
    var F = k*x;
    ...
    push();
		...
		translate(15, 0);
		showForce(F*PXSCALE*5, 90, CTENSION);
    pop();
    
    
    placeWords('set stiffness\nof the distorted part\nof the environment', 50, 280);

  placeTitleBold("The local environment affects the tension force: set stiffness, vary distortion");
}
