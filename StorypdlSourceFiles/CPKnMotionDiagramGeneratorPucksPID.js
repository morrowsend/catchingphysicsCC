// KnMotionDiagramGeneratorPucksPID
...
function setup(){
    ...
    displacementsbutton = new checkButton(213,750,"displacements",false);
    segmentsbutton = new checkButton(370,750,"track segments",false);
