// {CPSpIdentifyPathwayMechanicalPID}{430}{280}
...
function draw() {
	...
	push();
		...
		placeWordsFrame("Look for a force acting on something that's moving.", 10,10,232,60);
		push();
		translate(295, 13);
			scale(1.2);
...
placeTitleBold("Identifying an mechanical working pathway");
}
