// {CPStForceAccumulatesMomentum1DPID}{800,400}
...
//            paused
    ...
    push();
        translate(300,120);
        drawPoVObject("Alice");
            showForce(accelerationAccumlates*PXSCALE,90,CIDEARED);
        push();
            translate((-velocityNow*50),-32);
            showMomentum(velocityNow*PXSCALE,90,CCONCYAN);
        pop();
    ...
    placeWords("set\nforce",230,230);
  placeTitleBold("set force and watch momentum accumulate");
}
