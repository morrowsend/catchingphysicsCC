// {CPSpIdentifyPathwayParticlesPID}{430}{280}
...
function draw() {
	...
	push();
		...
		placeWordsFrame("Look for collections of warm particles moving.", 10,10,232,60);
		push();
		translate(295, 13);
			scale(1.2);
...
placeTitleBold("Identifying an heating by particles pathway");
}
