// {CPSpElectricalDevicesSwitchingFromPathwayMotorPID}{800}{600}
...
function draw() {
	...
	var topslice = 1-twoWayDivvy.getValue(0);
	 ...
	 drawDescribePowerTwo("electrical","particles","mechanical",topslice,bottomslice);

	placeTitleBold('A motor switches from the electrical pathway');
}
