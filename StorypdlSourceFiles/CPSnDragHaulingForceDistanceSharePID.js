// CPSnDragHaulingForceDistanceSharePID
...
function draw() {
	...
	placeWords("force", locpucks[1][0]+50, locpucks[1][1]-28);
		push();
			...
			translate(0,20);
			showForce(values[0].y/7, 90, CIDEABLUE);
        ...
        push();
			...
			translate(0,20);
			showForce(values[1].y/7, 90, CIDEABLUE);
        pop();
   ...
   placeTitleBold("Trade-off: a choice to drag through a fluid");
}
